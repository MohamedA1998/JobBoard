<x-layout>
    ...
    <x-card class="mb-4 text-sm" x-data="">
        <form x-ref="filters" id="filtering-form" action="{{ route('jobs.index') }}" method="GET">
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <x-text-input name="min-salary" value="{{ request('min-salary') }}" placeholder="From" form-ref="filters" />
                        <x-text-input name="max-salary" value="{{ request('max-salary') }}" placeholder="To" form-ref="filters" />
                    </div>
                </div>
            ...
            <x-button class="w-full">Fillter</x-button>
        </form>
    </x-card>
